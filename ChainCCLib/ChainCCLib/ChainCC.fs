module ChainCCRunner
    ...
    type ChainCC(_code: string) =
        ...
        member val private validCommands: string array = [|"match "; "if"; "loop"; "ref "; "result "; "delete "; "push "; "ope "; "let "; "set "; "result "; "lock "; "unlock "; "call "; "goto "; "gotob "; "new_proc"; "delete_proc"; "pop"; "trim "; "pull"; "success "|]
